<h2><a href="https://leetcode.com/contest/biweekly-contest-183/problems/minimum-swaps-to-move-zeros-to-end">4316. Minimum Swaps to Move Zeros to End</a></h2><h3>Easy</h3><hr><p>You are given an integer array <code>nums</code>.</p>
